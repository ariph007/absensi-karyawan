...
<div class="table-responsive">
    ...
    $shift = mysqli_query($koneksi, "SELECT * FROM `shift`");
    $no=1;
    while($d = mysqli_fetch_array($shift)){
        // $jenis_kelamin = $row['jenis_kelamin']=='P'?'Perempuan':'Laki laki';
				?>
			<tr>
				<td><?php echo $no; ?></td>
				<td><?php echo $d['id_shift']; ?></td>
				<td><?php echo $d['nama_shift']; ?></td>
				<td><?php echo $d['waktu_shift']; ?></td>
