					...
					<div class="page-content">
						...
						<div class="row">
							...
							//	include_once 'data_karyawan.php';
								...
								<form name="update_karyawan" method="post" action="hapus_data_proses.php">
						        <table border:none border-top:none class="table">
						            ...
						            <tr>
						                <td><input type="submit" name="update" value="HAPUS" class="btn btn-danger" onclick="return confirm('Apakah anda yakin ingin menghapus data ini?');"></td>
						            </tr>
						        </table>
						    </form>
