						...
						<div class="row">
							<div class="col-xs-12">
								...
								if(isset($_POST['tambah']))
								{
								    ...
								    // update user data
								    $result2 = mysqli_query($koneksi, "INSERT INTO `karyawan` VALUES ('','$nama','$jenis_kelamin','$join_date', '$tempat_lahir','$tanggal_lahir','$id_department','$alamat','$jabatan','$level','$password')");
								...
								<form name="update_karyawan" method="post" action="tambah_data_karyawan.php">
						        <table border:none border-top:none class="table">
						            <tr>
						                <td>NIK</td>
						                <td><input class="col-xs-3" type="text" name="nik" value="" readonly></td>
						            </tr>
						            <tr>
						                <td>Nama</td>
						                <td><input class="col-xs-3" type="text" name="nama" value=""></td>
						            </tr>
												<tr>
						                <td>Jenis Kelamin</td>
						                <td>
						            ...
						            <tr>
						                <td>Join Date</td>
						                <td><input class="col-xs-3" type="date" name="join_date" value=""></td>
						            </tr>
												<tr>
						                <td>Tempat Lahir</td>
						                <td><input class="col-xs-3" type="text" name="tempat_lahir" value=""></td>
						            </tr>
						            <tr>
						                <td>Tangal Lahir</td>
						                <td><input class="col-xs-3" type="date" name="tanggal_lahir" value=""></td>
						            </tr>
						            <tr>
						                <td>Department</td>
						                <td>
												...
												<tr>
													 <td>Jabatan</td>
													 <td><input class="col-xs-3" type="text" name="jabatan" value=""></td>
											 </tr>
											 <tr>
													 <td>Alamat</td>
													 <td><input class="col-xs-3" type="text" name="alamat" value=""></td>
											 </tr>
											 <tr>
													 <td>Level</td>
													 <td>
											 ...
											 <tr>
													 <td>Password</td>
													 <td><input class="col-xs-3" type="text" name="password" value=""></td>
											 </tr>
						            <tr>
						                <td><input type="submit" name="tambah" value="TAMBAH" class="btn btn-secondary"></td>
						            </tr>
						        </table>
						    </form>
