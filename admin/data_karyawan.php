...
<div class="table-responsive">
	...
	//	$result = mysqli_query($koneksi,"SELECT * FROM karyawan LIMIT $mulai, $halaman");
    ...
    $karyawan = mysqli_query($koneksi, "SELECT karyawan.nik, karyawan.nama,karyawan.jenis_kelamin,karyawan.join_date,karyawan.tempat_lahir,karyawan.tanggal_lahir,department.nama_department,karyawan.jabatan,karyawan.alamat,karyawan.level,karyawan.password FROM `karyawan` LEFT JOIN department ON karyawan.id_department=department.id_department LIMIT $posisi,$batas");
    //$no=$mulai+1;
		$nomor=$posisi+1;
		//$nohal =$mulai+1;
    while($d = mysqli_fetch_array($karyawan)){
        // $jenis_kelamin = $row['jenis_kelamin']=='P'?'Perempuan':'Laki laki';
			...
			<tr>
				...
				<td><button class="btn btn-minier btn-reload">
			<?php echo	"<a href='edit_data_karyawan.php?nik=$d[nik]'>
					Edit
				</a>"
				?></button><button class="btn btn-minier btn-reload">
				<?php echo	"<a href='hapus_data_karyawan.php?nik=$d[nik]'>
						Hapus
					</a>"
					?></button>
				</td>
...
if ($i != $halaman){
	echo " <a href=\"data_karyawan.php?halaman=$i\">$i</a> | ";
}
else{
	echo " <b>$i</b> | ";
}
echo "<p>Total Karyawan : <b>$jmldata</b> orang</p>";
 ?>
								...
								<div class="row">
									<div class="col-xs-12">
										<button class="btn btn-success">
											<a href='tambah_data_karyawan.php'>
													ADD
												</a>
										</button>
